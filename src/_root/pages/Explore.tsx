...
const Explore = () => {
  ...
  const { data:searchedPosts, isFetching: isSerachFetching } = useSearchPost(debouncedValue);
  ...
  const shouldShowPosts = !showSearchResults && posts?.pages.every(
  ...
  return (
    <div className="explore-container">
      ...
      <div className="flex flex-wrap gap-9 w-full max-w-5xl">
            {showSearchResults? (
              <SearchResults 
                isSearchFetching={isSerachFetching}
